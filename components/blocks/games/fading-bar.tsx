...
export function FadingBar({ className, children }: FadingBarProps) {
  ...
  return (
    <div
      className={cn(
        'flex h-12 flex-row items-center gap-2 bg-linear-to-r from-green-900/0 via-green-900/60 via-30% to-green-950 px-2 inset-shadow-sm inset-shadow-green-900/50',
        className
      )}
    >
