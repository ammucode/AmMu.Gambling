...
export const api = {
  messages: {
    create: createApiLeaf<
      'mutation',
      typeof import('../functions/messages').create
    >(
    ...
    list: createApiLeaf<'query', typeof import('../functions/messages').list>(
      createGeneratedFunctionReference<
        'query',
        'public',
        typeof import('../functions/messages').list
      >('messages:list'),
      { type: 'query' }
    ),
  },
  users: {
    getOwnInfo: createApiLeaf<
      'query',
      typeof import('../functions/users').getOwnInfo
    >(
      createGeneratedFunctionReference<
        'query',
        'public',
