...
const procedureRegistry = {
  "getSession": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../../games/session").getSession>("games/session:getSession"), () => (require("../../games/session") as Record<string, unknown>)["getSession"])],
  "maybeStartSession": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../../games/session").maybeStartSession>("games/session:maybeStartSession"), () => (require("../../games/session") as Record<string, unknown>)["maybeStartSession"])],
} as const;
...
export function createGamesSessionCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createGamesSessionHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
