...
registerProcedureNameLookup(
  {
  "games/balance.ts": [{ column: 36, line: 44, name: "games/balance:cashOut" }, { column: 3, line: 10, name: "games/balance:info" }, { column: 3, line: 23, name: "games/balance:invest" }],
  "games/craps/easy.ts": [{ column: 3, line: 17, name: "games/craps/easy:betPassline" }, { column: 3, line: 11, name: "games/craps/easy:getPoint" }],
