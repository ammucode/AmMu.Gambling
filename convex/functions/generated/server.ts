...
registerProcedureNameLookup(
  {
  "games/control.ts": [{ column: 36, line: 99, name: "games/control:cashout" }, { column: 3, line: 59, name: "games/control:getOrStartSession" }, { column: 3, line: 78, name: "games/control:invest" }],
