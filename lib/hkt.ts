import { Arg0, Arg1, Arg2, Call1, Call1W, Call2W, Curry, Param0, Param1, RetType, TArg, TypeLambda, TypeLambda1, TypeLambda2, TypeLambdaG } from "hkt-core";
...
export namespace ObjectHKTs {
  ...
  export interface Entries extends TypeLambdaG<[["T", Record<PropertyKey, unknown>]]> {
    signature: (
      entries: TArg<this, "T">,
